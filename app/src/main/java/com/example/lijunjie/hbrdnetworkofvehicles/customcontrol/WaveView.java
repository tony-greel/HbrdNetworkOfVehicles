...
/**
 * Created by lijunjie on 2018/6/16.
 */
...
public class WaveView extends View {
    ...
    public void setBaseLine(int baseLine) {
        this.baseLine = 1000-baseLine*68;
        Log.d("TT", String.valueOf(baseLine));
        invalidate();
    }

    private int baseLine = 1000;// 基线，用于控制水位上涨的，这里是写死了没动，你可以不断的设置改变。
    private Paint mPaint;
    private int waveHeight = 200;// 波浪的最高度
    ...
    private void initView(){
        mPaint = new Paint();
        mPaint.setColor(Color.parseColor("#DEBB8B"));
